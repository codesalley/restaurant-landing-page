export default function foodList() {
  ...
  p.innerText = 'galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining';
  ...
  mainList.classList.add('list-parent');
